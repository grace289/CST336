...
<body>
    ...
    <p>You can log in using usernames <strong>bob</strong> joe <strong>sue</strong>. </p>
    <p id="last-login"></p>
    <p id="last-login-status"></p>
    <!--Form to enter credentials-->
    <form method="post" id="form" action="verifyUser.php">
        <input id="username" type="text" name="username" onkeyup="OnkeyUpEvent(this);" placeholder="Username" />
        <br/>
